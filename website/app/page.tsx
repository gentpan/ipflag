...
export default function Home() {
  ...
  return (
    <main>
      ...
      <footer className="site-footer shell"><a className="brand" href="#top"><FlagMark /><span>IP FLAG</span></a><p>{t.footerCopy}</p><div><a href="/privacy/">{t.footerPrivacy}</a><span>© 2026 IP Flag</span></div></footer>
    </main>
  );
}
